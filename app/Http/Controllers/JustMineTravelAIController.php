...
5. Reply in this language: {$language}
6. Answer only based on the questions/answers listed.

EOT;
        $prompt .= "Questions are in English, but answers may be in another language.\n";
